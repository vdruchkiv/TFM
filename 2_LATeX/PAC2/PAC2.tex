...
\begin{center}
 ...
 \hline\hline
 \cite{schmidt2008humoral}  & \href{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE11121}{GSE11121}& Homo sapiens & Microarrays  \\
 \hline
...
Les dades d'estudi \cite{li2017zbtb7b} són ja preprocessades per Ricardo Gonzalo Sanz i Sanchez Pla i estan disponibles a \href{https://github.com/alexsanchezpla/StatisticalAnalysisOfMicroarrayData}{github}. De la carpeta \textit{results} he agafat les taules \textit{topAnnotated\_KOvsWT\_COLD.csv} i \textit{topAnnotated\_KOvsWT\_RT.csv}. Sanz i Pla utilitzen el paquet \helvetica{ReactomePA} per a l'anàlisi d'enriquement. Repeteixo doncs el seu anàlisi utilitzant l'aplicació. 

\begin{enumerate}

\item Ellegeixo la espècie \textit{Mus musculus} per a GO, KEGG i Reactome.
...
Addicionalment a l'anàlisi ORA podem fer mitjançant l'aplicació l'anàlis GSEA per  les rutes de Reactome. Per fer-ho:
...
L'anàlisi GO no retorna cap termes GO amb el nivell de significació de 0.05. Pujant el nivell de significació fins 0.1 retorana un llistat dels termes enriquits per als components cel·lulars.
