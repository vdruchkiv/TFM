...
\newglossaryentry{Enrichment Map}
{
    name={Enrichment Map},
...
\newglossaryentry{Gene-Concept-Network}
{
    name={Gene-Concept-Network},
    description={La visualització de gens al voltant dels conceptes on els gens poden ser connectats amb rutes diferents. D'aquesta manera es pot veure quins gens contribueixen a què les rutes siguin diferencialment expressades}
}


\newglossaryentry{GO-Plot}
{
    name={GO-Plot},
...
\newglossaryentry{KEGG Pathway}
{
    name={KEGG Pathway},
    description={Les rutes descarregades de la base de dades KEGG on els gens enriquits són emfatitzats}
}

\newglossaryentry{Reactome Pathway}
{
...
%\input{thanks}                %% this is a suggestion: you have to create this file on deman
...
\input{Memoria}   %% remove this line to get rid of the style chapter
