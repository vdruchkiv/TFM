...
Les rutes de Rectome són similares a les rutes de KEGG. La seva implementació amb Bioconductor, com ho veruem properament, no visualitza les rutes originales mostrades per \href{https://reactome.org/PathwayBrowser/}{Pathway Browser} de Reactome. La visualització és més modesta i ofereix només les relacions nominals no direccionals. D'aquesta manera però podem identificar quanes coneccions amb altres gens de la ruta tenen els gens diferencialment expressats. 
